CREATE DATABASE IF NOT EXISTS oabmysql;

CREATE USER IF NOT EXISTS  'superuser'@'%' IDENTIFIED BY 'xlmiStlsT7staq2SiW6d';
GRANT ALL PRIVILEGES ON *.* TO 'superuser'@'%'  WITH GRANT OPTION;
FLUSH PRIVILEGES;

CREATE USER IF NOT EXISTS 'normaluser'@'%'  IDENTIFIED BY 'tlhiDedoSoFrl7o1aslt';
...
ALTER TABLE `uf` ENABLE KEYS;
UNLOCK TABLES;



ALTER TABLE `municipio`
ADD CONSTRAINT `fk_municipio_ufid`
FOREIGN KEY (`ufid`)
REFERENCES `uf` (`id`)
ON DELETE CASCADE
ON UPDATE CASCADE;
...
ADD CONSTRAINT `fk_advogado_municipioid`
